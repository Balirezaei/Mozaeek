...
namespace MozaeekCore.Domain.Contract.IntegrationEvents
{
    public class ExecutiveTechnicianRegistered : IEvent
    {
        ...
        public ExecutiveTechnicianRegistered(long id, DateTime dateTime, string firstName, string lastName, string nationalCode, Guid eventId, DateTime publishDateTime)
        {
            Id = id;
