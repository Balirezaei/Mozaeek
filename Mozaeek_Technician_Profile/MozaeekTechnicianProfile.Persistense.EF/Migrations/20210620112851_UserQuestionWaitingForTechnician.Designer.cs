...
namespace MozaeekTechnicianProfile.Persistense.EF.Migrations
{
    ...
    [Migration("20210620112851_UserQuestionWaitingForTechnician")]
    partial class UserQuestionWaitingForTechnician
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MozaeekTechnicianProfile.Domain.TechnicianOnlineRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TechnicianOnlineRequest");
                });
            ...
            modelBuilder.Entity("MozaeekTechnicianProfile.Domain.UserQuestionWaitingForTechnician", b =>
                {
                    ...
                    b.Property<string>("QuestionVicePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MozaeekTechnicianProfile.Domain.TechnicianOnlineRequest", b =>
                {
                    b.HasOne("MozaeekTechnicianProfile.Domain.Technician", null)
                        .WithMany("TechnicianOnlineRequests")
                        .HasForeignKey("TechnicianId");
                });
