...
export class HtmlClassService {
  ...
  getLogo() {
    ...
    if (brandSkin === 'light') {
      return toAbsoluteUrl('/media/logos/mosaik-32.png');
    } else {
      return toAbsoluteUrl('/media/logos/mosaik-32.png');
    }
  }
  ...
  initHeader() {
    ...
    if (headerSelfWidth === 'fluid') {
      ...
      objectPath.push(this.classes, 'header_container', 'page-container');
    }
  }
  ...
  initSubheader() {
    ...
    if (subheaderWidth === 'fluid') {
      ...
      objectPath.push(this.classes, 'subheader_container', 'page-container');
    }
  ...
  initContent() {
    ...
    if (objectPath.get(this.config, 'content.width') === 'fluid') {
      ...
      objectPath.push(this.classes, 'content_container', 'page-container');
    }
  }
  ...
  initFooter() {
    ...
    if (objectPath.get(this.config, 'footer.self.width') === 'fluid') {
      ...
      objectPath.push(this.classes, 'footer_container', 'page-container');
    }
  }
