...
namespace MozaeekCore.RestAPI.Bootstrap
{
    public static class QueryHandlerRegistration
    {
        ...
        {
            services.AddScoped<IPreRequestQueryFacade, PreRequestQueryFacade>();
            ...
            services.AddScoped<IRequestPriceQueryFacade, RequestPriceQueryFacade>();
            services.AddScoped<ISubjectPriceQueryFacade, SubjectPriceQueryFacade>();
            services.AddScoped<IUserSearchQueryFacade, UserSearchQueryFacade>();
            services.AddScoped<IPriceInqueryQueryFacade, PriceInqueryQueryFacade>();
