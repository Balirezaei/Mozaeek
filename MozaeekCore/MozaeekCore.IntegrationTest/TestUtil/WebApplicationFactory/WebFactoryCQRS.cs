...
{
    public class WebFactoryCQRS<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder
                .UseEnvironment("IntegrationTest").ConfigureServices(services =>
                {
                    ...
                    //    var mongoInit = new MongoInitDb(mongoDb, subjectQueryFactory, requestTargetQueryFactory, announcementQueryFactory, labelQueryFactory);
                    //    mongoInit.DropDb();
                    //    mongoInit.InitDb();
                    //}
                });
