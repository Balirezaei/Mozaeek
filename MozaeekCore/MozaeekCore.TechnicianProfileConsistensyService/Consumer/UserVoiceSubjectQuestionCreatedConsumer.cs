...
{
    public class UserVoiceSubjectQuestionCreatedConsumer : IConsumer<UserVoiceSubjectQuestionCreated>
    {
        private readonly IOutboxRepository _outboxRepository;
        private readonly ITechnicianUserQuestionService _technicianUserQuestionService;
        public UserVoiceSubjectQuestionCreatedConsumer(IOutboxRepository outboxRepository
        ...
        public async Task Consume(ConsumeContext<UserVoiceSubjectQuestionCreated> context)
        {
