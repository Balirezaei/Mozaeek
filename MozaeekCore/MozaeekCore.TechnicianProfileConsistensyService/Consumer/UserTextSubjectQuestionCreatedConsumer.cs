...
{
    public class UserTextSubjectQuestionCreatedConsumer : IConsumer<UserTextSubjectQuestionCreated>
    {
        private readonly IOutboxRepository _outboxRepository;
        private readonly ITechnicianUserQuestionService _technicianUserQuestionService;
        public UserTextSubjectQuestionCreatedConsumer(IOutboxRepository outboxRepository
        ...
        public async Task Consume(ConsumeContext<UserTextSubjectQuestionCreated> context)
        {
            ...
            await _technicianUserQuestionService.CreateTechnicianUserQuestion(new UserQuestionWaitingForTechnician()
            {
                ...
                QuestionTextDescription = context.Message.QuestionTextDescription,
                ...
                SubjectTitle = context.Message.SubjectQuestionInfo.SubjectTitle,
                SubjectId = context.Message.SubjectQuestionInfo.SubjectId,
            });
