...
{
    public class UserTextRequestQuestionCreatedConsumer : IConsumer<UserTextRequestQuestionCreated>
    {
        private readonly IOutboxRepository _outboxRepository;
        private readonly ITechnicianUserQuestionService _technicianUserQuestionService;
        public UserTextRequestQuestionCreatedConsumer(IOutboxRepository outboxRepository
        ...
        public async Task Consume(ConsumeContext<UserTextRequestQuestionCreated> context)
        {
