...
namespace MozaeekCore.Persistense.EF.Migrations
{
    ...
    [Migration("20210831110246_definitRequestOrgToRequestDomain")]
    partial class definitRequestOrgToRequestDomain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MozaeekCore.Domain.AnnouncementLabel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.AnnouncementRequestOrg", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AnnouncementRequestOrg");
                });

            modelBuilder.Entity("MozaeekCore.Domain.AnnouncementSubject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.RequestDefiniteRequestOrg", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("RequestDefiniteRequestOrg");
                });
            ...
            modelBuilder.Entity("MozaeekCore.Domain.RequestRequestOrg", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.AnnouncementRequestOrg", b =>
                {
                    b.HasOne("MozaeekCore.Domain.Announcement", "Announcement")
                        .WithMany("AnnouncementRequestOrgs")
                        .HasForeignKey("AnnouncementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MozaeekCore.Domain.RequestDefiniteRequestOrg", b =>
                {
                    b.HasOne("MozaeekCore.Domain.DefiniteRequestOrg", "DefiniteRequestOrg")
                        .WithMany("RequestDefiniteRequestOrgs")
