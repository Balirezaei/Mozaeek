...
namespace MozaeekCore.Persistense.EF.Migrations
{
    ...
    [Migration("20210510192955_addingUrltoFileTable")]
    partial class addingUrltoFileTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MozaeekCore.Domain.File.File", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.Announcement", b =>
                {
                    b.HasOne("MozaeekCore.Domain.File.File", "File")
                        .WithMany()
