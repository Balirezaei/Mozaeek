...
namespace MozaeekCore.Persistense.EF.Migrations
{
    ...
    [Migration("20210418153242_connecteRequest")]
    partial class connecteRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MozaeekCore.Domain.Pricing.PriceUnit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.RequestConnection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ConnectedRequestId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MozaeekCore.Domain.Pricing.RequestPriceHeader", b =>
                {
                    b.HasOne("MozaeekCore.Domain.Pricing.PriceUnit", "PriceUnit")
            ...
            modelBuilder.Entity("MozaeekCore.Domain.RequestConnection", b =>
                {
                    b.HasOne("MozaeekCore.Domain.Request", null)
                        .WithMany("RequestConnections")
                        .HasForeignKey("RequestId");
                });
