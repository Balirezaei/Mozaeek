...
namespace MozaeekCore.Persistense.EF.Migrations
{
    ...
    [Migration("20210418161521_connecteRequest2")]
    partial class connecteRequest2
    {
            ...
            modelBuilder.Entity("MozaeekCore.Domain.Request", b =>
                {
                    ...
                    b.OwnsMany("MozaeekCore.Domain.RequestConnection", "RequestConnections", b1 =>
                        {
                            b1.Property<long>("RequestId")
                                .HasColumnType("bigint");
                            ...
                            b1.Property<long>("ConnectedRequestId")
                                .HasColumnType("bigint");

                            b1.HasKey("RequestId", "Id");

                            b1.ToTable("RequestConnection");
