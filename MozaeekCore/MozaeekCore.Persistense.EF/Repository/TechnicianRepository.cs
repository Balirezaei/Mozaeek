...
//technician.TechnicianAttachments.FirstOrDefault(m => m.AttachmentType == AttachmentType.PersonalPhoto);
            ...
            //    personalPhoto.FileExtension = attachment.FileExtension;
        ...
        public async Task<Technician> Find(long id)
        {
            return await _context.Technicians.SingleOrDefaultAsync(t => t.Id == id);
        }
    }
}
