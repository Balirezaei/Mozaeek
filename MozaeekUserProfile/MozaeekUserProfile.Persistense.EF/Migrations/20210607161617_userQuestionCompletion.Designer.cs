...
namespace MozaeekUserProfile.Persistense.EF.Migrations
{
    ...
    [Migration("20210607161617_userQuestionCompletion")]
    partial class userQuestionCompletion
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:Sequence:.QuestionCode", "'QuestionCode', '', '10000', '1', '', '', 'Int32', 'False'")
            ...
            modelBuilder.Entity("MozaeekUserProfile.Domain.UserQuestion", b =>
                {
                    ...
                    b.Property<string>("QuestionCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValueSql("'MOZ'+Substring(convert(varchar, getdate(), 112),1,6) + convert(varchar,(NEXT VALUE FOR QuestionCode) )");
